...
ut <- rbind( gintervention, gumea, ggtb, glund, 
            gwoman, gman, gyoung, gold,
            gbrca, glynch, 
            gARRmen, gARRwomen, gdegree1, gdegree2etc )

chisqpvalue <- c("","",
                 "", "", round(chisq.test(rbind(gumea, ggtb, glund))$p.value,digits=2),
...
rm( gintervention, gumea, ggtb, glund, 
            gwoman, gman, gyoung, gold,
            gbrca, glynch, 
...
ut <- rbind(gcontrol,  gumea, ggtb, glund, 
            gwoman, gman, gyoung, gold,
            gbrca, glynch, 
            gARRmen, gARRwomen, gdegree1, gdegree2etc )
